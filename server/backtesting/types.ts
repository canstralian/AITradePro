...
export interface IStrategy {
   ...
   * @param bar - Market data bar (OHLCV)
   * @param broker - Broker interface for placing orders and checking positions
   * @param symbol - The asset symbol being traded (e.g., 'BTC', 'ETH')
   * @returns Trading signal or null if no action
   */
  onBar(bar: MarketBar, broker: IBroker, symbol: string): Promise<Signal | null>;
