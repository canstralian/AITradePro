...
All YAML files are validated using `yamllint`:
...
#### Line Length
Maximum 120 characters per line (configurable in `.yamllint`)
...
- [ ] Validate with yamllint: `yamllint .github/workflows/your-workflow.yml`
